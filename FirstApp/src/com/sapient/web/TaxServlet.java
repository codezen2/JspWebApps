...
public class TaxServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		// presentation logic
		out.println("<h1 align='center'>TAX RETURNS<h1>");
		out.println("<hr/>");

		out.println(
				"<section style='min-height:400px; max-height:400px; margin:0 auto; width:80%; background-color:aqua;'>");

		out.println(
				"<table cellpadding='10' bgcolor='#dcfff5' style='margin:0 auto; background-color: #dcfff5; color: black;font-size: larger;'");
		out.println("<tr>");
